...
__all__ = [
    ...
    # ``annotations`` is the __future__ feature object, exposed by the pre-split
    # star-import surface and frozen into the API baseline; keep it listed so the
    # compat module's symbol set stays byte-identical.
    "annotations",
    "Any",
    "Callable",
    "Decimal",
