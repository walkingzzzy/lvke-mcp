...
_RULE_TARGETS: dict[str, set[str]] = {
    ...
    "FIN.WORKING_CAPITAL.DRIVER": {"finance_run", "finance_tables_package", "combined_deliverable"},
    "FIN.PERIOD.RECONCILIATION": {"finance_run", "finance_tables_package", "combined_deliverable"},
