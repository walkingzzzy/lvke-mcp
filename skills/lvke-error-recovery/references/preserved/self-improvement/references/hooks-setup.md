...
```bash
./.claude/skills/self-improvement/scripts/extract-skill.sh test-skill --dry-run
```
...
```bash
chmod +x ./.claude/skills/self-improvement/scripts/activator.sh
chmod +x ./.claude/skills/self-improvement/scripts/error-detector.sh
chmod +x ./.claude/skills/self-improvement/scripts/extract-skill.sh
```
