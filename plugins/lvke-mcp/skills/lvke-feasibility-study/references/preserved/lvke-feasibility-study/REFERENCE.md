...
8. After each domain step, call `feasibility_stage(status=completed)` with real input/output refs and the output basis hash. Use `feasibility_next_actions` for recovery.
